    ...
    <main>
      ...
      <ul>
        {Appointments.map((Appointment) => (
          <li key={Appointment.id}>{Appointment.type} {Appointment.appointmentDate ? (new Date(Appointment.appointmentDate).setHours(new Date(Appointment.appointmentDate).getHours()-1)).toLocaleString():null}</li>
        ))}
      </ul>
